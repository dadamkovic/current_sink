...
#define NLDAC_Pin GPIO_PIN_4
#define NLDAC_GPIO_Port GPIOA
#define CHANNEL_B_CURR_Pin GPIO_PIN_5
#define CHANNEL_B_CURR_GPIO_Port GPIOA
#define CHANNEL_A_CURR_Pin GPIO_PIN_6
#define CHANNEL_A_CURR_GPIO_Port GPIOA
